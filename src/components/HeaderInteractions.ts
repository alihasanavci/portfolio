export const mobileNavigationLinkClass =
  "transition-opacity duration-300 hover:opacity-70 focus-visible:opacity-70 focus-visible:outline-none [text-box-edge:cap_alphabetic] [text-box-trim:trim-both]";
